...
from .views import recommend_products_api, similar_products_api, hybrid_recommendations_api,add_user_interaction
...
urlpatterns = [
    ...
    path("add_interaction/", add_user_interaction, name="add-interaction"),
